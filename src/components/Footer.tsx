...
function FooterColumnTitle({ children }: { children: ReactNode }) {
  return (
    <p className="mb-4 font-display text-sm tracking-[0.14em] text-red-600 uppercase">
      {children}
    </p>
  );
}
...
function ContactRow({
  ...
  return (
    <div className="flex gap-3">
      <div
        className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-red-800/30 bg-red-950/40 shadow-[0_0_14px_rgba(220,38,38,0.15)]"
        aria-hidden
      >
        <Icon size={18} className="text-red-600 drop-shadow-[0_0_6px_rgba(220,38,38,0.7)]" />
      </div>
...
export function Footer() {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_90%_60%_at_50%_0%,rgba(220,38,38,0.09)_0%,transparent_60%)]"
        aria-hidden
      />
      <div
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12">
              ...
              <ContactRow icon={MapPin}>
                <address className="not-italic">
                  ...
                  <a
                    ...
                    className="mt-2.5 inline-flex items-center gap-1.5 text-xs font-medium tracking-wide text-red-600 transition-colors hover:text-red-500"
                  >
          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              <a
                ...
                className="glass-card group/phone flex items-center gap-3 rounded-2xl border border-white/8 p-4 transition-[border-color,box-shadow,transform] duration-300 hover:border-red-800/45 hover:shadow-[0_0_28px_rgba(220,38,38,0.2)] active:scale-[0.99]"
              >
                <div
                  className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-red-800/30 bg-red-950/40 transition-shadow duration-300 group-hover/phone:shadow-[0_0_18px_rgba(220,38,38,0.35)]"
                  aria-hidden
                >
                  <Phone
                    size={20}
                ...
                <div className="flex gap-3">
                  {socialLinks.map(({ label, href, icon: Icon }) => (
                    <a
                      ...
                      className="glass-card flex h-12 w-12 items-center justify-center rounded-full border border-white/8 text-red-600 transition-[border-color,box-shadow,transform,color] duration-300 hover:scale-105 hover:border-red-800/50 hover:text-red-500 hover:shadow-[0_0_24px_rgba(220,38,38,0.25)]"
                    >
                      <Icon size={20} />
                    </a>
                  ))}
        ...
        <div className="group/map relative mb-10 lg:mb-12">
          <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 rounded-lg border border-white/8 bg-white/[0.03] px-3 py-2 text-xs font-medium text-zinc-400 transition-colors hover:border-red-800/40 hover:text-red-500"
            >
              Rotas no Maps
              <ExternalLink size={12} aria-hidden />
            </a>
          ...
          <div className="footer-map-frame glass-card relative overflow-hidden rounded-2xl border border-white/8 shadow-[0_0_40px_rgba(0,0,0,0.4)] transition-[border-color,box-shadow] duration-500 group-hover/map:border-red-800/35 group-hover/map:shadow-[0_0_48px_rgba(220,38,38,0.12)]">
            <div
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-white/5 pt-6 sm:flex-row sm:gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="#inicio"
              className="glass-card flex h-10 w-10 items-center justify-center rounded-full border border-white/8 text-zinc-500 transition-[border-color,color,box-shadow] duration-300 hover:border-red-800/45 hover:text-red-500 hover:shadow-[0_0_16px_rgba(220,38,38,0.2)]"
