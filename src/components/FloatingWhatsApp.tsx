...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="whatsapp-fab group fixed right-5 bottom-5 z-40 flex items-center gap-0 overflow-hidden rounded-full border border-red-700/50 bg-[#25D366] text-white shadow-[0_0_24px_rgba(37,211,102,0.4),0_0_28px_rgba(220,38,38,0.3)] transition-[transform,box-shadow,gap,padding] duration-300 hover:scale-[1.04] hover:border-red-600/70 hover:shadow-[0_0_36px_rgba(37,211,102,0.55),0_0_44px_rgba(220,38,38,0.45)] active:scale-[0.98] motion-reduce:transition-none motion-reduce:hover:scale-100 sm:right-6 sm:bottom-6"
