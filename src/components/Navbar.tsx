    ...
    <>
      ...
      >
        <div className="mx-auto flex h-[70px] max-w-7xl items-center justify-between px-6 lg:px-12">
          {/* ── Logo ── */}
          <a href="#inicio" className="group flex items-center gap-0">
            {/* Icon mark */}
            ...
            <div className="-ml-0.5 flex flex-col leading-none">
              ...
              <span className="font-display text-xl tracking-[0.06em] text-white">
                GARROTE
              </span>
            </div>
          </a>
          ...
          <nav className="hidden items-center gap-1 md:flex">
            {navLinks.map(({ label, href }) => (
              ...
              >
                {label}
                <span className="absolute inset-x-4 bottom-1.5 h-px scale-x-0 bg-red-600 shadow-[0_0_8px_rgba(220,38,38,0.7)] transition-transform duration-200 group-hover:scale-x-100 origin-left" />
              </a>
            ))}
          </nav>
          ...
          <div className="flex items-center gap-3">
            <a
              href="#planos"
              className="neon-red-soft btn-shimmer relative hidden overflow-hidden rounded-lg bg-red-600 px-5 py-2.5 text-[13px] font-semibold tracking-wide text-white shadow-[0_0_18px_rgba(220,38,38,0.45)] transition-all duration-300 hover:bg-red-700 hover:shadow-[0_0_32px_rgba(220,38,38,0.65)] md:inline-flex"
            >
              Começar Agora
            </a>
            ...
            <button
              ...
              aria-label="Menu"
              className="navbar-menu-btn flex h-10 w-10 items-center justify-center rounded-lg border border-red-600/25 bg-white/5 transition-colors hover:border-red-600/40 md:hidden"
            >
              {mobileOpen ? (
