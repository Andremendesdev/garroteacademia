    ...
    >
      <div className="mb-3 flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          <div
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-red-800/30 bg-red-950/50 font-display text-lg text-red-500"
            aria-hidden
          >
            {initial}
          </div>
...
export function GoogleReviews() {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_50%_at_50%_100%,rgba(220,38,38,0.06)_0%,transparent_55%)]"
        aria-hidden
      />
        ...
        >
          <div className="max-w-xl">
            ...
            <h2 id="reviews-heading" className="space-y-0 leading-none">
              ...
              <span className="block font-display text-[clamp(1.75rem,5vw,3rem)] leading-[0.9] tracking-[0.02em] text-red-600 text-glow-red">
                RECOMENDA.
              </span>
            </h2>
          </div>
          ...
          <a
            ...
            className={`glass-card flex w-fit items-center gap-3 rounded-2xl border border-white/8 px-4 py-3 transition-[border-color,box-shadow] duration-300 hover:border-red-800/45 hover:shadow-[0_0_24px_rgba(220,38,38,0.18)] ${
