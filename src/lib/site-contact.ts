/**
 * Dados de contato da Academia Garrote.
 *
...
export const siteContact = {
  ...
  address: {
    ...
    mapsLinkUrl: "https://maps.google.com/?q=Academia+Garrote",
  },
  phone: {
  ...
  whatsapp: {
    ...
    message:
      "Olá! Vim pelo site da Academia Garrote e gostaria de mais informações.",
  },
  hours: {
  ...
  social: {
    instagram: "https://instagram.com/academiagarrote",
    facebook: "https://facebook.com/academiagarrote",
  },
} as const;
